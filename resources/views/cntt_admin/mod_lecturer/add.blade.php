                        ...
                        <div class="col-lg-8 col-md-8 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="txtFullName"
                                    placeholder="Vui lòng nhập họ và tên giảng viên" value="{{ old('txtFullName') }}">
                            </div>
                            <div class="form-group">
                                <label for="Position">Chức vụ</label>
                                <input type="text" class="form-control" name="txtPosition"
                                    placeholder="Vui lòng nhập chức vụ" value="{{ old('txtPosition') }}">
                            </div>
                            <div class="form-group">
                                <label for="Content">Sơ lược giảng viên</label>
                                <textarea name="txtContent" rows="5" class="form-control"
                                    placeholder="Nhập nội dung sơ lược">{{ old('txtContent') }}</textarea>
                            </div>

                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" name="chkStatus" checked="checked" }}> Giảng viên công khai
                                </label>
                            </div>
                        </div>
