                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="txtContent" rows="5" class="form-control" placeholder="Nhập nội dung chi tiết của chuyên ngành" >{{ old('txtContent',$majorEdit['cnttMajorDetail']) }}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="ImageMajor">Hình đại diện</label>
                            <img src="{{ asset('public/upload/imgMajor/'.$majorEdit['cnttMajorImage']) }}" class="img-thumbnail" alt="Major Image Feature" width="300" height="300">
                            <input type="file" name="imgNews">
                        </div>
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" name="chkStatus" {{  ($newsEdit['cnttNewsStatus'] == 1)? "checked":" " }} > Công khai chuyên ngành
                            </label>
                        </div>
                    </div>
                    <!-- /.box -->
