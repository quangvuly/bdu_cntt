                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="txtCateName" placeholder="Vui lòng nhập tên danh mục" value="{{ old('txtCateName') }}">
                        </div>
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" checked="checked" name="chkStatus"> Danh mục công khai
                            </label>
                        </div>
                    </div>
                    <!-- /.box -->
